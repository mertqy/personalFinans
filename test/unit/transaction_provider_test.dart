...
import 'package:personal_finans/providers/budget_provider.dart';
...
void main() {
  ...
  group('TransactionNotifier Tests', () {
    ...
    test('processRecurring should create transactions for due subscriptions', () async {
      ...
      print('DEBUG: Transactions after processing: ${txs.length}');
      for (var t in txs) {
        print('DEBUG: Found TX: ${t.description}, amount: ${t.amount}');
      }
